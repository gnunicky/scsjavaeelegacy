 ...
 */
@Stateless(mappedName = "RM3Bean")
public class RM3 extends RM implements RMLocal{

    @WebServiceRef(wsdlLocation = "META-INF/wsdl/leandro3.homeunix.org_8080/Legacy-war/FE_Database.wsdl")
