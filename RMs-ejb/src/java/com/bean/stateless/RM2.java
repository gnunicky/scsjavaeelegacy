 ...
 */
@Stateless(mappedName = "RM2Bean")
public class RM2 extends RM implements RMLocal{

    @WebServiceRef(wsdlLocation = "META-INF/wsdl/leandro2.homeunix.org_8080/Legacy-war/FE_Database.wsdl")
